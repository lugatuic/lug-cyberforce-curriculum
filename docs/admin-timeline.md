...
**Owner:** AJ  
**For:** LUG CTF Group admin team, next year's leads
...
- Confirm teams are prepping (check in with captains)
- Offer recording sessions
- Remind teams that this is due 1 week after scenario drops

**Early November: Security Documentation Due**
- Teams should have their SSH work done
- Remind them to document vulnerabilities found
- This is your last chance before competition day

**Late November: Competition Day**
- Confirm logistics (transportation, location, time)
- Make sure all teams know where to meet + when
- Van rental should be booked
- Food/snacks arranged (if doing that)
...
- [ ] Post announcements to Discord + email
- [ ] Pin on #cyberforce-announcements channel 
- [ ] Set up Discord roles (Competitor, Mentor, Admin, etc.)
- [ ] Create team-specific channels (waiting for team formation)
...
### **JULY (Registration & Team Formation)**
...
**Mid-July (Critical):**
- [ ] CyberForce announces registration date → Post immediately
...
- [ ] If anyone missed deadline, tell them NOW (might be too late, but worth trying)
...
- [ ] Confirm CyberForce next steps (official dates confirmed?)
...
**First week:**
- [ ] School starts (things get busy)
- [ ] Hold welcome event
- [ ] Post notes from welcome event to Discord
- [ ] First team meetings happen (probably)
- [ ] Update Discord with "What to study this month"

**Mid-September:**
- [ ] Admin check-in: How are teams doing? Any issues?
- [ ] Confirm biweekly meeting schedule with teams
- [ ] Monitor CyberForce for scenario hints
- [ ] Update Discord with upcoming events

**Late September:**
- [ ] Teams should be prepping actively
- [ ] Check that attendance is good (people showing up?)
- [ ] If attendance is bad, reach out to team captains
- [ ] CyberForce may start teasing scenario
...
- [ ] Teams start recording their C-Suite videos
...
- [ ] Confirm transportation:
  - [ ] Van rental booked
  - [ ] Pick-up/drop-off times confirmed
  - [ ] Teams know where to meet before departing
- [ ] Confirm competition day logistics:
  - [ ] Food/snacks arranged (or not)
...
### **DECEMBER (Debrief & Planning)**

**Early December:**
- [ ] Scorecards arrive from CyberForce → Share with teams
- [ ] Post results (team rankings, highlights)
- [ ] Congratulate teams on effort + learning

**Mid-December:**
- [ ] Send debrief survey to teams: "What went well? What was hard? What should we change?"
- [ ] Collect feedback
- [ ] Admin meeting: "Let's review 2026. What did we learn?"
...
| CyberForce coordinators | Confirm dates, ask questions | Mid-July (registration), late-Oct (scenario) |
...
| Item | Cost | Timeline |
|------|------|----------|
| Van rental | - | Mid-Nov, book in advance |
| Gas | - | Mid-Nov |
| Food/snacks |  - | Mid-Nov |
...
- ✅ Did teams feel supported + prepared?
- ✅ Were communication efforts successful (people knew what was happening)?
...
- Michael
- Caleb
- Anyone else critical (team captain if issues arise)

**Agenda template:**
1. **What happened last month?** (Events, registrations, issues)
2. **What's next?** (Deadlines coming up)
3. **Problems to solve** (If teams struggling, logistics issues, etc.)
4. **Decisions** (Do we need to change anything?)
5. **Next meeting** (Same time next month, or different?)

**Keep notes** in `/admin/admin-meeting-notes.md`
...
- [ ] Update CONTRIBUTING.md if processes changed
- [ ] Update README.md if structure changed
- [ ] Create GitHub Issues for 2027 lead's attention
- [ ] Write a personal note: "Here's what you need to know..."

---

**Last updated:** June 2026  
**Questions?** Ask @AJ or check HANDOFF.md
